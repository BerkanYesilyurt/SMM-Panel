...
<head>
    ...
    <title>{{$configsArray['title']}} - Register</title>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="https://github.com/BerkanYesilyurt/SMM-Panel" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    ...
                    <form class="mb-3" action="/register" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="contact" class="form-label">Skype</label>
                            <input
                                type="text"
                                class="form-control"
                                id="contact"
