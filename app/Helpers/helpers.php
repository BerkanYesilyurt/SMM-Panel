        ...
        if (Auth::user()->is_banned) {
            ...
            if ($ban_record) {
                if($ban_record->permanent){
                    ...
                    return 'Your account is temporarily suspended until <span class="badge bg-danger">' . date('d F Y h:i:s', strtotime($ban_record->until_at)) . '</span>';
                }
            }
        }
        return null;
